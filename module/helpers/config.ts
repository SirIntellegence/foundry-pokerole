...
export const POKEROLE = {
  ...
  types: Object.keys(POKEROLE.typeMatchups),
...
POKEROLE.moveGroups = ['learned', ...POKEROLE.ranks.slice(1), 'maneuver'];
  ...
  skills: ['brawl', 'channel', 'clash', 'evasion', 'alert', 'athletic', 'nature', 'stealth', 'allure', 'etiquette', 'intimidate', 'perform', 'crafts', 'lore', 'medicine', 'science'],
  socialAttributes: ['tough', 'cool', 'beauty', 'cute', 'clever'],
  extraAttributes: ['happiness', 'loyalty'],
...
POKEROLE.natureConfidence = {
  ...
  getAllAttributesAndSkills: function () {
    return [...POKEROLE.getAllAttributes(), ...POKEROLE.skills];
  },
